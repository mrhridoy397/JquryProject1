        ...
        <div class="col-md-12 pt-1">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="page-heading pb-3"><i class="fa fa-user" aria-hidden="true"></i> Manage User</div>
                </div> <!-- /panel-heading -->
                <div class="panel-body">
                    ...
                    <div class="div-action pull pull-right" style="padding-bottom:20px;">
                        <button class="btn btn-info button1" data-toggle="modal" id="addUserModalBtn" data-target="#addUserModal"> <i class="fa fa-plus-square" aria-hidden="true"></i> Add User </button>
                    </div> <!-- /div-action -->
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="submitUserForm" action="api/createUser.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="div-result">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="userInfo">
                            <form class="form-horizontal" id="editUserForm" action="api/editUser.php" method="POST">
                                <br />
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer removeProductFooter">
                <button type="button" class="btn btn-info" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
                <button type="button" class="btn btn-danger" id="removeProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Remove</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>
