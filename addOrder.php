            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    ?>
                        ...
                        <form class="form-horizontal" method="POST" action="api/createOrder.php" id="createOrderForm">
                            ...
                            <!--/form-group-->
                            <div class="form-group">
                                <label for="clientContact" class="col-sm-2 control-label">Representative</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="representative" name="representative" placeholder="Representative" autocomplete="off" />
                                </div>
                            </div>
                            <!--/form-group-->
                            <table id="productTable" class="table mt-5">
                                <thead>
                                    <tr>
                                        <th style="width:12%;">Product</th>
                                        <th style="width:12%;">&nbsp;&nbsp;Pack Size</th>
                                        <th style="width:12%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M.R.P</th>
                                        <th style="width:12%;">&nbsp;&nbsp;Flat Rate</th>
                                        <th style="width:12%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Available
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity
                                        </th>
                                        <th style="width:12%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</th>
                                        <th style="width:12%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sample
                                            <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    // echo "<option value='".$row[0]."' id='changemainProduct".$row[0]."'>".$row[1]."</option>";
                                    // 	echo"<pre>";
                                    // 	print_r($row);
                                        ...
                                        <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="productmainName[]" id="productmainName<?php echo $x; ?>" onchange="getProductmainData(<?php echo $x; ?>)">
                                                        <option value="">SELECT</option>
                                                        <?php
                                                        $productSql = "SELECT `product`.`product_id`,`product`.`product_name`,
                                                    `product`.`mrp`,`product`.`rate`,`product`.`quantity` FROM `product`
                                                    ...
                                                    <!-- <input type="hidden" name="productmainName[]" id="productmainName<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row[0]; ?>" /> -->
                                                    <small class="product_name_msg"></small>
                                                </div>

                                                <!-- <input type="text" value="<?php echo $row[1]; ?>" disabled="true" autocomplete="off" class="form-control"> -->
                                            ...
                                            <td style="padding-left:20px; display: none;">
                                                <div class="form-group">
                                                    <p id="available_squantity<?php echo $x; ?>"></p>
                                                </div>
                                            </td>
                                            <!-- Sample Quantity -->
                                            <td style="padding-left:25px;">
                                                <div class="form-group">
                                                    <input type="number" name="squantity[]" id="squantity<?php echo $x; ?>" onkeyup="getsTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="0" />
                                                </div>
                                            </td>
                                            <td style="padding-left:20px;">
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-danger btn-sm removeProductRowBtn" onclick="removeProductRow(<?php echo $x; ?>)"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                            ...
                            <div class="mt-3 mb-4 align-center">
                                <button type="button" class="btn btn-info" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="fa fa-plus-circle" aria-hidden="true"></i></i> Add Row </button>
                                <button type="submit" class="btn shadow btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> Save Change</button>
                                <button type="button" class="btn shadow btn-danger" onclick="resetOrderForm()"><i class="fa fa-exchange" aria-hidden="true"></i> From Reset</button>
                                <button type="button" class="btn shadow btn-danger" onclick="pageResetFun()"><i class="fa fa-exchange" aria-hidden="true"></i> Page Reset</button>
                            </div>
                        </form>
                    <?php } else if ($_GET['o'] == 'manord') {
                        // manage order
                    ...
                    ?>
                        ...
                        <form class="form-horizontal" method="POST" action="api/editOrder.php" id="editOrderForm">
					...
					WHERE orders.order_id = {$orderId}";
                            ...
                            <table class="table" id="productTable">
                                <thead>
                                    <tr>
                                        <th style="width:12%;">Product</th>
                                        <th style="width:12%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pack Size</th>
                                        <th style="width:11%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M.R.P</th>
                                        <th style="width:11%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Flat Rate</th>
                                        <th style="width:11%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Available <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</th>
                                        <th style="width:11%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</th>
                                        <th style="width:11%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sample <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quantity</th>
                                ...
                                <tbody>
                                    ...
                                    $orderItemSql = "SELECT order_item.order_item_id, order_item.order_id, order_item.product_id, order_item.quantity,order_item.squantity, order_item.rate, order_item.total FROM order_item WHERE order_item.order_id = {$orderId}";
                                        ...
                                        <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">
                                            <td style="margin-left:20px;">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="productmainName[]" id="productmainName<?php echo $x; ?>" onchange="getProductmainData(<?php echo $x; ?>)">
                                                        ...
                                                        <?php
                                                        $productSql = "SELECT `product`.`product_id`,`product`.`product_name` 
											FROM product WHERE active = 1 AND STATUS = 1 AND quantity != 0";
                                                        $productData = $con->query($productSql);
                                                        ...
                                                        while ($row = $productData->fetch_array()) {
                                                            ...
                                                            echo "<option value='" . $row[0] . "' id='changemainProduct" . $row[0] . "' " . $selected . " >" . $row[1] . "</option>";
                                                        } // /while 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="productName[]" id="productName<?php echo $x; ?>" onchange="getProductData(<?php echo $x; ?>)">
                                                        ...
                                                        while ($row = $productData->fetch_array()) {
                                                            ...
                                                            echo "<option value='" . $row['product_id'] . "' id='changeProduct" . $row['product_id'] . "' " . $selected . " >" . $row['attribute'] . "</option>";
                                                        } // /while 
                                            ...
                                            <td>
                                                ...
                                                if ($productData->num_rows > 0) {
                                                    while ($row = $productData->fetch_array()) {
                                                ?>
                                                        <input type="text" name="mrp[]" id="mrp<?php echo $x; ?>" autocomplete="off" disabled="true" class="form-control" value="<?php echo $row['mrp']; ?>" />
                                                        <input type="hidden" name="mrpValue[]" id="mrpValue<?php echo $x; ?>" autocomplete="off" class="form-control" value="<?php echo $row['mrp']; ?>" />
                                                <?php
                                                    } // /while 
                                                }
                                                ?>
                                            ...
                                            <td style="padding-left:20px;">
                                                <div class="form-group">
                                                    <input type="number" name="squantity[]" id="squantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="1" value="<?php echo $orderItemData['squantity']; ?>" />
                                                </div>
                                            </td>
                                            <td style="padding-left:20px;">
                            ...
                            <div class="form-group editButtonFooter">
                                <div class="mt-3 mb-4 align-center">
                                    <button type="button" class="btn btn-info" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="fa fa-plus-circle" aria-hidden="true"></i> Add Row </button>

                                    <input type="hidden" name="orderId" id="orderId" value="<?php echo $_GET['i']; ?>" />

                                    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> Save Changes</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="updatePaymentOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Save changes</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
